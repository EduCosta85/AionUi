...
export const github = {
  getRepo: bridge.buildProvider<GitHubRepoInfo, { cwd?: string; project_id?: string }>('github:getRepo'),
  setRepo: bridge.buildProvider<void, { project_id: string; owner: string; repo: string }>('github:setRepo'),
  setToken: bridge.buildProvider<void, { token: string }>('github:setToken'),
  listIssues: bridge.buildProvider<GitHubIssue[], GitHubListIssuesFilter & { cwd?: string; project_id?: string }>(
    'github:listIssues'
  ),
  createIssue: bridge.buildProvider<GitHubIssue, GitHubCreateIssueInput & { cwd?: string; project_id?: string }>(
    'github:createIssue'
  ),
  getIssue: bridge.buildProvider<
    GitHubIssue,
    { number: number; owner?: string; repo?: string; cwd?: string; project_id?: string }
  >('github:getIssue'),
};
